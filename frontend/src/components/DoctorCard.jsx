...
import { Heart, Calendar, CheckSquare } from 'lucide-react';
...
const DoctorCard = ({ doc, onDoctorSelect }) => {
    ...
    React.useEffect(() => {
        const fetchSchedules = async () => {
            try {
                const schedules = await getAvailableSchedules(doc.id);
    ...
    return (
        ...
        >
            ...
            <div style={{ padding: '1.5rem', flex: '1 1 45%', display: 'flex', gap: '1.5rem', borderRight: '1px solid #e2e8f0' }}>
            ...
            <div style={{ padding: '1.5rem', flex: '1 1 55%', display: 'flex', flexDirection: 'column' }}>
